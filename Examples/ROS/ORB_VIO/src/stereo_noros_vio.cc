...
int main(int argc, char **argv)
{
    ...
    if (argc != 8)
    {
        ...
        cerr << endl
             << "Usage: ./project path_to_ORBVOC.TXT path_to_euroc.yaml path_to_imu/data.csv path_to_cam0/data.csv path_to_cam0/data path_to_cam1/data strName" << endl;
        // ros::shutdown();
        return 1;
    }
    ...
    {
        cerr << endl
             << "There is no enough images." << endl;
    }
